...
struct BoardView: View {
    ...
    /// Three states, not two. An API that is running and holds no league
    /// answers happily with an empty list; telling someone to start a server
    /// they have already started sends them after the wrong thing, which has
    /// cost this project an afternoon more than once.
